...
namespace GenshinLike
{
    public class CameraZoom : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            curTargetDistance = defaultDistance;
        }
        ...
        private void Zoom()
        {
            ...
            curTargetDistance = Mathf.Clamp(curTargetDistance + zoomValue, minimumDistance, maximumDistance);

            float currentDistance = framingTransposer.m_CameraDistance;

            if (currentDistance == curTargetDistance)
                return;

            float lerpedZoomValue = Mathf.Lerp(currentDistance, curTargetDistance, smoothing * Time.deltaTime);
